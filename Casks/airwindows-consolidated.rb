cask "airwindows-consolidated" do
  ...
  desc "Airwindows Consolidated DAW Plugin"
  ...
  preflight do
    system_command "/usr/bin/xar", args: ["-xf", "#{staged_path}/airwindows-consolidated-macOS-#{version}.pkg", "-C", staged_path]
    system_command "/usr/bin/tar", args: ["-xf", "#{staged_path}/airwindows-consolidated_VST3.pkg/Payload", "-C", staged_path]
  end

  vst3_plugin "Airwindows Consolidated.vst3", target: "/Library/Audio/Plug-Ins/VST3/Airwindows Consolidated.vst3"
